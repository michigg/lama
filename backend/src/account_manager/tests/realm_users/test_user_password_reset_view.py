...
class RealmUserPasswordResetViewTest(TestCase):
    ...
    def test_without_login(self):
        response = self.client.get(reverse('realm-user-password-reset', args=[self.realm_1.id, self.ldap_user_1.dn, ]))
    ...
    def test_with_admin_login(self):
        ...
        self.assertContains(response, 'Die Passwort zurücksetzen E-Mail wurde erfolgreich versendet.')
