    ...
    <b-row v-if="!isEditMode" class="neo-morph">
      <b-col>
        ...
        <div class="d-flex mt-3">
          <b-btn v-if="$can('change', 'Realm')" @click="isEditMode = !isEditMode" variant="primary" href="#" class="mr-auto">
            Bereichsinformationen anpassen
          </b-btn>
          <a v-if="realm.email && $can('change', 'Realm')" class="btn btn-secondary p-2">
            Test Mail
          </a>
        </div>
      </b-col>
