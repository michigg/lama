...
urlpatterns = [
    ...
    path('realm/<int:realm_id>/users/add/', account_manager.views.realm_user_views.realm_user_add,
         name='realm-user-add'),
    ...
    path('realm/<int:realm_id>/user/delete/direct/single/<str:user_dn>/',
         account_manager.views.realm_user_views.realm_user_direct_delete,
         name='realm-user-direct-delete'),
